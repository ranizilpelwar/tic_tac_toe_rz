...
class TestMatchTypeManager < Test::Unit::TestCase
  ...
  def test_when_match_number_is_provided_as_zero_then_an_invalid_value_error_is_raised
    match_type_manager = TicTacToeRZ::MatchTypeManager.new
    assert_raises TicTacToeRZ::InvalidValueError do match_type_manager.get_match_type(0) end
  end

  def test_when_match_number_is_provided_as_four_then_an_invalid_value_error_is_raised
    match_type_manager = TicTacToeRZ::MatchTypeManager.new
    assert_raises TicTacToeRZ::InvalidValueError do match_type_manager.get_match_type(4) end
  end
